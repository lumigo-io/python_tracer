...
from .compat import PY3, binary_type, integer_types, string_types, text_type, unichr
...
def _make_iterencode(
    ...
    if _int_as_string_bitcount is not None and (
        _int_as_string_bitcount <= 0 or not isinstance(_int_as_string_bitcount, integer_types)
    ):
