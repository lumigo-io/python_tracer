...
def parse_triggered_by(event: dict):  # type: ignore[no-untyped-def]
    """
...
def _parse_unknown(event: dict):  # type: ignore[no-untyped-def]
    result = {"triggeredBy": "unknown"}
    return result


def _is_step_function(event: Union[List, Dict]):  # type: ignore[no-untyped-def]
    return (
...
def _parse_step_function(event: dict):  # type: ignore[no-untyped-def]
    result = {
...
def _is_supported_http_method(event: dict):  # type: ignore[no-untyped-def]
    return (
...
def _is_load_balancer_method(event: dict):  # type: ignore[no-untyped-def]
    return (
        "httpMethod" in event  # noqa
        and "headers" in event  # noqa
...
def _parse_http_method(event: dict):  # type: ignore[no-untyped-def]
...
def _parse_load_balancer_method(event: dict):  # type: ignore[no-untyped-def]
    result = {
...
def _parse_http_method_v1(event: dict):  # type: ignore[no-untyped-def]
    result = {
        "triggeredBy": "apigw",
        "httpMethod": event.get("httpMethod", ""),
...
def _parse_http_method_v2(event: dict):  # type: ignore[no-untyped-def]
    result = {
        "triggeredBy": "apigw",
...
def _is_supported_sns(event: dict):  # type: ignore[no-untyped-def]
    return event.get("Records", [{}])[0].get("EventSource") == "aws:sns"


def _parse_sns(event: dict):  # type: ignore[no-untyped-def]
    return {
        "triggeredBy": "sns",
...
def _is_event_bridge(event: dict):  # type: ignore[no-untyped-def]
    return (
...
def _parse_event_bridge(event: dict):  # type: ignore[no-untyped-def]
...
def _is_supported_cw(event: dict):  # type: ignore[no-untyped-def]
    return event.get("detail-type") == "Scheduled Event" and "source" in event and "time" in event


def _parse_cw(event: dict):  # type: ignore[no-untyped-def]
...
def _is_supported_streams(event: dict):  # type: ignore[no-untyped-def]
...
def _is_sns_inside_sqs_record(record: dict):  # type: ignore[no-untyped-def]
    body = record.get("body")
