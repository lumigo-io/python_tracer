...
try:
    ...
    # Import a snapshot of _get_handler from the lambda runtime interface client (awslambdaric), in the unlikely case
    # that the bootstrap module is not available
